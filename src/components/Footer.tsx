...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: Github, href: "https://github.com/Mimieamichy", label: "GitHub" },
    { icon: Twitter, href: "https://x.com/js_mimie", label: "X (Twitter)" },
    { icon: Mail, href: "mailto:amichy07@gmail.com", label: "Email" },
  ];
